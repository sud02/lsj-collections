/**
 * FALLBACK — mobile-number step of the Firebase phone OTP flow.
 *
 * Replaced by EmailStep.tsx. Kept, commented out, so the phone flow can be
 * restored: uncomment below, uncomment lib/firebase.ts and the phoneLogin
 * helpers in lib/auth.ts, re-enable /auth/phone-login on the backend, and swap
 * EmailStep back out in AuthModal.tsx.
 */
